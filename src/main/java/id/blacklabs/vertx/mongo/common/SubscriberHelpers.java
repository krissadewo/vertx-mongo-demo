...
/**
 * @author krissadewo
 * @date 4/30/21 10:29 AM
 * <p>
 * taken from https://github.com/mongodb/mongo-java-driver-reactivestreams/blob/1.0.x/examples/tour/src/main/tour/SubscriberHelpers.java
 */
